    ...
    <div class="row">
      <div class="col-12">
        <div class="mb-5">
          ...
          <p class="text-center m-0">Already have an account? <a href="/login">Sign in</a></p>
        </div>
      </div>
    </div>
          ...
          <div class="col-12 col-lg-5">
           <form method="POST" action="SignUpUser">
              <div class="row gy-3 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control border-0 border-bottom rounded-0" name="confirm_password" id="confirm_password" placeholder="Confirm Password" required>
                ...
                <div class="col-12 mb-3">
                  ...
                  <div class="d-flex gap-4">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="role" id="role_student" value="1" checked>
                      <label class="form-check-label" for="role_student">
                        Student
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="role" id="role_teacher" value="2">
                ...
                <div class="col-12">
                  <div class="form-check">
                    ...
                    <label class="form-check-label text-secondary" for="terms">
                      I agree to the <a href="#!" class="link-secondary text-decoration-none">Terms of Service</a> and <a href="#!" class="link-secondary text-decoration-none">Privacy Policy</a>
                    </label>
                  </div>
                </div>
                <div class="col-12">
          ...
          <div class="col-12 col-lg-5 d-flex align-items-center">
            <div class="d-flex gap-3 flex-column w-100 ">
              <a href="#!" class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
                ...
                <span class="ms-2 fs-6 flex-grow-1">Register with Google</span>
              </a>
              <a href="#!" class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
                ...
                <span class="ms-2 fs-6 flex-grow-1">Register with Apple</span>
              </a>
              <a href="#!" class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
                ...
                <span class="ms-2 fs-6 flex-grow-1">Register with Facebook</span>
              </a>
            </div>
          </div>
        </div>
